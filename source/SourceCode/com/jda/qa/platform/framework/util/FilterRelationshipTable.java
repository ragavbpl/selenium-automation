...
public class FilterRelationshipTable implements TableInterface {
	...
	String tablegridLoc = "//table[@id='tblUpdttblefltrRlnshp']";

	String tableColCntLoc = tablegridLoc
			+ "/descendant::tr[@class='j-grid-column-header-row']/td[@class='j-grid-column-header']";	

	String tableRowCntLoc = tablegridLoc
			+ "/descendant::tr[@class='j-grid-auto-checkbook']";

	public FilterRelationshipTable(TestBrowser browser, String tableProps,
	...
	public String getTableCellContent(int rowNum, String colHdrName) {
		...
		return browser.getText(colContentLoc).trim();
	...
	public void selectTableRow() {	
		...
		if (rowNum == 0) {
			...
			String selRowLoc = "//input[@value='"+objectDetails.get("RELATION_NAME")+"']";
