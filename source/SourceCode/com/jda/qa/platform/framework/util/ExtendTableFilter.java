...
public class ExtendTableFilter implements TableInterface,
	...
	String tablegridLoc = "//table[@id='tblExtndfltrExnd']";

	String tableColCntLoc = tablegridLoc
			+ "/descendant::td[@class='j-grid-column-header']";
	String tableRowCntLoc = tablegridLoc
			+ "/descendant::tr[@class='j-grid-auto-checkbook']";

	public ExtendTableFilter(TestBrowser browser, String tableProps,
	...
	public String getTableCellContent(int rowNum, String colHdrName) {
		...
		String inputColContentLoc = colContentLoc
	...
	public int getTableRowNumber(String pkColValue) {
		...
		for (; rowNum < tableRowCount + 1; rowNum++) {
			...
			if (colContent.trim().equals(LocatorFormatter.formatLocator(pkColValue))) {
				foundStatus = true;
				break;
			}
		}
